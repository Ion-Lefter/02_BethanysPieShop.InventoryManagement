...
namespace _02_BethanysPieShop.InventoryManagement
{
    ...
    {
        private string directory = @"C:\Users\ion.lefter\LND\My_Projects\02_DotNET_Projects\02_BethanysPieShop.InventoryManagement\Repository\";
        ...
        public List<Product> LoadProductsFromFile()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < productsAsString.Length; i++)
                {
                    ...
                    if (!success)
                    {
                        currency = Currency.USD;//default value
                    }
