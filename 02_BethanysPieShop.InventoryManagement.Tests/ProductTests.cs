...
namespace _02_BethanysPieShop.InventoryManagement.Tests
{
    ...
    {
        //Arrange
        Product product = new Product(1, "Sugar", "Lorem ipsum", new Price() { ItemPrice = 10, Currency = Currency.EUR }, UnitType.PerKg, 100);
